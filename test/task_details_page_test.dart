...
void main() {
  ...
  group('TaskDetailsPage', () {
    testWidgets('shows todo title', (tester) async {
      await tester.pumpWidget(wrap(TaskDetailsPage(todo: sampleTodo)));
    ...
    testWidgets('shows description when present', (tester) async {
      ...
      await tester.pumpAndSettle();
      expect(
        find.text('Research competitors and market trends'),
        findsOneWidget,
      );
    });
    ...
    testWidgets('shows completed status for completed todo', (tester) async {
      await tester.pumpWidget(
        wrap(TaskDetailsPage(todo: sampleTodo.copyWith(completed: true))),
      );
      await tester.pumpAndSettle();
