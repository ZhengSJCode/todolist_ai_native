...
void main() {
  group('AppRouter', () {
    ...
    testWidgets('navigating to /home shows AppShell with home tab', (tester) async {
    ...
    testWidgets('tapping Get Started on LetsStartPage navigates to home', (tester) async {
      final router = buildAppRouter(startAtHome: false);
      await tester.pumpWidget(
        ProviderScope(child: MaterialApp.router(routerConfig: router)),
      );
